    ...
    return (
        <div className="md-surface" style={{
            ...
            <div style={{
                ...
                padding: '0 16px', backgroundColor: 'var(--md-sys-color-surface-container-low)',
                ...
                <div style={{ display: 'flex', gap: '8px', height: '100%', alignItems: 'center' }}>
                    <button
                        ...
                        style={{
                            ...
                            color: outputTab === 'terminal' ? 'var(--md-sys-color-primary)' : 'var(--md-sys-color-on-surface-variant)',
                            fontSize: 'var(--md-sys-typescale-label-large-font-size)',
                            fontWeight: 'var(--md-sys-typescale-label-large-font-weight)',
                            fontFamily: 'var(--md-sys-typescale-label-large-font-family)',
                            cursor: 'pointer',
                            borderBottom: outputTab === 'terminal' ? '3px solid var(--md-sys-color-primary)' : '3px solid transparent',
                            height: '100%',
                    ...
                    {(language.startsWith('python') || language.startsWith('java')) && (
                        <button
                            ...
                            style={{
                                padding: '0 16px', border: 'none', background: 'none',
                                color: outputTab === 'visuals' ? 'var(--md-sys-color-primary)' : 'var(--md-sys-color-on-surface-variant)',
                                fontSize: 'var(--md-sys-typescale-label-large-font-size)',
                                fontWeight: 'var(--md-sys-typescale-label-large-font-weight)',
                                fontFamily: 'var(--md-sys-typescale-label-large-font-family)',
                                cursor: 'pointer',
                                borderBottom: outputTab === 'visuals' ? '3px solid var(--md-sys-color-primary)' : '3px solid transparent',
                                height: '100%',
                                transition: 'all 0.2s var(--md-sys-motion-easing-standard)',
                                display: 'flex', alignItems: 'center', gap: '8px'
                            }}
                        >
                            <span className="material-symbols-rounded" style={{ fontSize: '18px' }}>monitoring</span>
                            Visuals {plotImage && '●'}
                        </button>
                    )}
                </div>
